...
function createTimeline(words, container, icons) {
  ...
  function createDot(word, index) {
    ...
    diagonal.classList.add("diagonal", "hide"); // add the hide class here
  ...
  function addClickEventToDot(dot) {
    dot.addEventListener("click", function () {
      ...
      if (lastClicked) {
        ...
        if (lastClicked.querySelector(".diagonal")) {
          lastClicked.querySelector(".diagonal").classList.add("hide");
        }
      }
      dot.classList.add("bigger");
      if (dot.classList.contains("bigger")) {
        dot.querySelector(".diagonal").classList.remove("hide");
      } else {
        dot.querySelector(".diagonal").classList.add("hide");
      }
...
function createTimeline(words, container, icons) {
  ...
  function createDot(word, index) {
    ...
    const diagonal = document.createElement("p");
    diagonal.classList.add("diagonal", "hide");
    diagonal.innerText = word;
...
function addClickEventToDot(dot) {
  dot.addEventListener("click", function () {
    console.log("clickado el que tengo aqui colgado");
    if (lastClicked === dot) {
      return;
    }
    if (lastClicked) {
